    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .summary:
            ...
            let rows: [(String, String)] = [
                ...
                ("整体倒计时", mode.overallDuration.parchmentFormattedDuration),
...
final class SessionDetailViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .tasks:
            ...
            content.secondaryText = "\(task.hand.rawValue) · \(task.state.title)" + (task.state == .completed ? " · \(task.duration.parchmentFormattedDuration)" : "")
    ...
    private func overallCountdownText(for session: SessionSnapshot) -> String {
        ...
        return remaining >= 0
            ? "剩余 \(remaining.parchmentFormattedDuration)"
            : "超出预计 \((-remaining).parchmentFormattedDuration)"
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .summary:
            let rows = [
                ...
                ("点击事件", "\(task.tapCount)"),
                ("持续时间", task.duration.parchmentFormattedDuration),
