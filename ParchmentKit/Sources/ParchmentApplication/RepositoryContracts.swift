...
public protocol SubjectRepository: Sendable {
    func subjects(matching query: String) async throws -> [ParchmentDomain.Subject]
    func subject(id: UUID) async throws -> ParchmentDomain.Subject?
    func save(_ subject: ParchmentDomain.Subject) async throws
    func delete(id: UUID) async throws
    func updates() async -> AsyncStream<[ParchmentDomain.Subject]>
}

public protocol SessionRepository: Sendable {
    func sessions(status: SessionStatus?) async throws -> [ParchmentDomain.Session]
    func session(id: UUID) async throws -> ParchmentDomain.Session?
    func create(subjectID: UUID, mode: String) async throws -> UUID
    func rename(id: UUID, name: String?) async throws
    func resume(id: UUID) async throws -> ParchmentDomain.Session
