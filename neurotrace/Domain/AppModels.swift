...
final class TestSession {
    ...
    var analysisReport: SessionAnalysisReport? {
        get {
            ...
            return try? JSONDecoder.neurotrace.decode(SessionAnalysisReport.self, from: analysisReportData)
        }
        set {
            analysisReportData = try? newValue.map { try JSONEncoder.neurotrace.encode($0) }
        }
    }
}
...
final class TaskRecord {
    ...
    var features: TaskFeatureSet? {
        get {
            ...
            return try? JSONDecoder.neurotrace.decode(TaskFeatureSet.self, from: featuresData)
        }
        set {
            featuresData = try? newValue.map { try JSONEncoder.neurotrace.encode($0) }
        }
    }
    ...
    var qualityFlags: [String] {
        get {
            ...
            return (try? JSONDecoder.neurotrace.decode([String].self, from: qualityFlagsData)) ?? []
        }
        set {
            qualityFlagsData = try? JSONEncoder.neurotrace.encode(newValue)
        }
    }
}

nonisolated extension JSONEncoder {
    static var neurotrace: JSONEncoder {
...
nonisolated extension JSONDecoder {
    static var neurotrace: JSONDecoder {
